...
function QtLoader(config)
{
    ...
    function loadEmscriptenModule(applicationName) {
        ...
        var emscriptenModuleSourcePromise = fetchText(applicationName + ".js?v=20260923").then(function(source) {
            emscriptenModuleSource = source
        });

        // Fetch and compile wasm module
        var wasmModule = undefined;
        var wasmModulePromise = fetchCompileWasm(applicationName + ".wasm?v=20260923").then(function (module) {
            wasmModule = module;
        });
